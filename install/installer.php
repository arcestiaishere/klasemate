	...
	switch($step) {
		...
		case 1:
			...
			if(is_writable("../config.php")) {
				...
				$file_content = "<?php
// MySQL configuration file for Klasemate
...
\$config['db_port']     = {$data['db_port']};";
		...
		case 4:
			...
			$sql[] = "INSERT INTO `c_config` (`field`, `value`) VALUES ('general_community_version', 'v0.1.0');";
