...
VALUES
	(1,'English (US)','en_US','Klasemate','me@arcestia.id',1),
	(2,'Portuguese (Brazil)','pt_BR','Laurensius Jeffrey Chandra','me@arcestia.id',1),
...
VALUES
	(1,'Default','default',1,'Klasemate','me@arcestia.id');

INSERT INTO `c_themes` (`theme_id`, `name`, `directory`, `is_active`, `author_name`, `author_email`)
VALUES
	(1,'Default (Light)','default-light',1,'Klasemate','me@arcestia.id');
